...
# MODIFICACION (Reto): se movieron 2 obstaculos respecto al mapa original:
#   (5, 4) -> (5, 6)
#   (6, 6) -> (7, 5)
# Se verifico con un recorrido en anchura (BFS) que sigue existiendo
# un camino valido desde INICIO hasta META con este nuevo mapa.
OBSTACULOS = {
    (0, 3), (1, 3), (2, 1), (2, 2), (2, 3),
    (3, 5), (4, 5), (5, 2), (5, 3), (5, 6),
    (7, 5),
